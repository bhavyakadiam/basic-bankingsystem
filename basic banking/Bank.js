function Transfer() 
{
var myaccount=parseInt(document.getElementById('BhavyaBalance').innerText);
...
let myaccount=parseInt(document.getElementById('BhavyaBalance').innerText)-transfer_Amount;
...
document.getElementById('BhavyaBalance').innerText=myaccount;
alert("Continue")
document.getElementById('BhavyaBalance').innerText=myaccount;
